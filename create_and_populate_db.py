"""
Create a fresh database and populate it with books.
"""
import sqlite3
import os

def create_database():
    """Create a new SQLite database with the books table."""
...
def add_books(conn):
    ...
    books = [
        # Existing books with increased quantities
...
def list_books(conn):
    ...
    for book in books:
        ...
        print(f"ID: {book[0]:<3} | {book[1]:<60} | {book[2]:<25} | Available: {book[3]}/{book[4]}")
